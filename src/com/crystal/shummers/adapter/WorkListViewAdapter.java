...
public class WorkListViewAdapter extends BaseAdapter{
	...
	public WorkListViewAdapter(Activity a, List<Work> d){
		activity = a;
		data = d;
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		final Work item = data.get(position);
		//item.setPosition(position);
		
		if(convertView == null){
			vi = inflater.inflate(R.layout.work_item, null);
			holder = new ViewHolder();
			
			holder.date_label = (TextView) vi.findViewById(R.id.li_date);
			holder.amount_label = (TextView) vi.findViewById(R.id.li_amount);
			holder.client_label = (TextView) vi.findViewById(R.id.li_client_name);
			holder.desc_label = (TextView) vi.findViewById(R.id.li_desc);
					...
					public void onClick(DialogInterface dialog, int which) {
						...
						case DELETE:
							...
							.setPositiveButton("Yes", new OnClickListener() {
								...
								public void onClick(DialogInterface dialog, int which) {
									// TODO Auto-generated method stub
									WorkData wd = new WorkData(activity);
									wd.removeWork(item.getId());
									
									WorkList.workItems.remove(position);
									WorkList.notifyAdapter();
